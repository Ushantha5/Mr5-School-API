...
Return ONLY valid JSON, no markdown formatting, no code blocks.`;
    ...
    return {
      description: courseDetails.description || getDefaultDescription(courseTitle),
      category: courseDetails.category || "Other",
      level: courseDetails.level || "Beginner",
      keyTopics: courseDetails.keyTopics || [],
    };
  } catch (error) {
    console.error(`Error generating details for "${courseTitle}":`, error.message);
    return getDefaultCourseDetails(courseTitle);
  }
}
...
function getDefaultDescription(title) {
  ...
  } else if (lowerTitle.includes("motion graphics") || lowerTitle.includes("after effects")) {
  ...
  } else if (lowerTitle.includes("resume") || lowerTitle.includes("interview")) {
  ...
  } else if (lowerTitle.includes("typography") || lowerTitle.includes("color")) {
  ...
  } else if (lowerTitle.includes("artificial intelligence") || lowerTitle.includes("ai")) {
  ...
  } else if (lowerTitle.includes("no-code") || lowerTitle.includes("app development")) {
  ...
  } else if (lowerTitle.includes("automation") || lowerTitle.includes("zapier") || lowerTitle.includes("n8n")) {
  ...
  } else if (lowerTitle.includes("communication") || lowerTitle.includes("presentation")) {
  ...
  } else if (lowerTitle.includes("subscription") || lowerTitle.includes("enterprise") || lowerTitle.includes("business")) {
...
function categorizeCourse(title) {
  ...
  if (lowerTitle.includes("full-stack") || lowerTitle.includes("devops") || lowerTitle.includes("app development") || lowerTitle.includes("llm")) {
    return "Development";
  } else if (lowerTitle.includes("cybersecurity") || lowerTitle.includes("security") || lowerTitle.includes("network") || lowerTitle.includes("law") || lowerTitle.includes("privacy")) {
    return "Security";
  } else if (lowerTitle.includes("ui/ux") || lowerTitle.includes("design") || lowerTitle.includes("logo") || lowerTitle.includes("branding") || lowerTitle.includes("canva") || lowerTitle.includes("3d") || lowerTitle.includes("blender") || lowerTitle.includes("animation") || lowerTitle.includes("typography") || lowerTitle.includes("portfolio") || lowerTitle.includes("motion graphics")) {
    return "Design";
  } else if (lowerTitle.includes("machine learning") || lowerTitle.includes("artificial intelligence") || lowerTitle.includes("ai")) {
    return "Technology";
  } else if (lowerTitle.includes("office") || lowerTitle.includes("resume") || lowerTitle.includes("interview") || lowerTitle.includes("time management") || lowerTitle.includes("communication") || lowerTitle.includes("presentation")) {
    return "Productivity";
  } else if (lowerTitle.includes("chatgpt") || lowerTitle.includes("prompt") || lowerTitle.includes("automation")) {
    return "Technology";
  } else if (lowerTitle.includes("subscription") || lowerTitle.includes("enterprise") || lowerTitle.includes("business")) {
    return "Business";
  } else if (lowerTitle.includes("kids") || lowerTitle.includes("learning")) {
...
function determineLevel(title) {
  ...
  if (lowerTitle.includes("fundamentals") || lowerTitle.includes("beginner") || lowerTitle.includes("basics") || lowerTitle.includes("office") || lowerTitle.includes("canva") || lowerTitle.includes("kids")) {
    return "Beginner";
  } else if (lowerTitle.includes("advanced") || lowerTitle.includes("masterclass") || lowerTitle.includes("enterprise") || lowerTitle.includes("devops")) {
    return "Advanced";
  } else {
    return "Intermediate";
  }
